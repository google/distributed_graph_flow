...
def _edge_schema(
    source: str = "n1",
    target: str = "n1",
    features: Optional[Mapping[str, schema_lib.FeatureSchema]] = None,
...
def _graph_schema(
    ...
    edge_set: Optional[schema_lib.EdgeSchema] = None,
...
def _create_graph(
    ids: Sequence[Any],
    f1: Optional[Union[np.ndarray, Sequence[Any]]] = None,
    edges: Optional[Union[np.ndarray, Sequence[Sequence[int]]]] = None,
    edge_features: Optional[Mapping[str, np.ndarray]] = None,
